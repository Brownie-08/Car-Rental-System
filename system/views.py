...
from .forms import CarForm, OrderForm, MessageForm, ContactForm
...
def home(request):
    if request.method == 'POST':
        ...
        subject = 'New Contact Form Submission from {}'.format(name)
        message = (
...
def contact_view(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            message = f"Name: {name}\nEmail: {email}\n\nComments:\n{comments}"
            send_mail(subject, message, email, ['udohpeterbrown@gmail.com'])
